...
export const comparisons: Comparison[] = [
  {
    ...
    metaDescription: "City-stay plans maximise walkability, beach access and independent flexibility; island tours maximise volcanic scenery, villages and Gran Canaria's…",
    kind: "versus",
