...
export const excursions: ExcursionPage[] = [
  {
    ...
    metaDescription: "Featured Editor's Choice Las Palmas shore excursion combining volcanic landscapes, mountain villages, food culture, coffee and local produce across Gran Canaria.",
  ...
  },
  {
    ...
    metaDescription: "Featured secondary Editor's Choice excursion to Roque Nublo with mountain scenery, dramatic viewpoints and Gran Canaria highland landscapes from Las Palmas cruise port.",
