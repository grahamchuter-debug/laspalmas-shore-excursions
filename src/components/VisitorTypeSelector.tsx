  ...
  return (
    <section className="section-padding bg-coastal-50 border-b border-coastal-100">
      <div className="container-wide">
        ...
        <h2 className="section-title mt-2">Which kind of Gran Canaria explorer are you?</h2>
        <p className="section-subtitle">Tell us how you travel — we&apos;ll point you to the guides and experiences that matter most.</p>
