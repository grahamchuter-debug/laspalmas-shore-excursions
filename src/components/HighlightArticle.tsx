...
export function HighlightArticle({ page }: { page: AttractionPage }) {
  ...
  return (
    <>
      ...
      />
      <PhotoHeroBand image={image} eyebrow="From Las Palmas Cruise Port" title={page.title} subtitle={page.tagline} compact />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {related.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">More Las Palmas guides</h2>
          ...
          <div className="mt-12">
            <FAQSection faqs={page.faqs} title={`${page.attractionName} from Las Palmas Cruise Port — FAQs`} />
          </div>
          <div className="mt-12">
            <PlanningLinks />
          </div>
