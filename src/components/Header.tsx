      ...
      <div className="container-wide flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <div className="hidden sm:block">
            <div className="font-display text-lg font-bold text-coastal-800 leading-tight">Las Palmas</div>
            <div className="text-xs text-granite-500 -mt-0.5">Gran Canaria</div>
          </div>
        </Link>
        ...
        <div className="hidden xl:block">
          <Link href="/shore-excursions" className="btn-accent text-sm">Explore Excursions</Link>
        </div>
      ...
      {open && (
        <nav className="xl:hidden border-t border-coastal-100 bg-white px-4 py-4" aria-label="Mobile navigation">
          <div className="flex flex-col gap-1">
            ...
            <Link href="/shore-excursions" className="rounded-lg px-4 py-3 text-sm font-semibold text-sandstone-500 hover:bg-coastal-50" onClick={() => setOpen(false)}>Explore Excursions</Link>
          </div>
        </nav>
      )}
    </header>
