...
export const metadata = buildMetadata({
  title: "Las Palmas Cruise Ship Schedules",
  description:
    "Las Palmas cruise ship schedules by year and month. See which ships call at Port of Las Palmas port before booking shore excursions, city walls walks or Lokrum Island tours.",
  path,
  keywords: ["Las Palmas cruise ship schedule", "Las Palmas cruise calendar", "Port of Las Palmas ship schedule"],
});
...
export default function ShipSchedulesPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Las Palmas Cruise Ship Schedules", description: "Las Palmas cruise ship schedules by year and month.", path })]} />
      <PageHero title="Las Palmas Cruise Ship Schedules" subtitle="See which ships are in port before you book Las Palmas excursions. Times and berths are indicative — always confirm with your cruise line." compact />
